...
export function Projects() {
  ...
  return (
    <div className={styles.projects}>
      ...
      <Project image={FetchTable} description='The front-end makes an axios request to the nodejs API, which is connected to the Postgresql database and receives data, which is then displayed in the table. ' name="Table with fetched from API data" techs='Axios, Node JS, SCSS, HTML, PostgreSQL'/>
